...
const RequestForm: React.FC<RequestFormProps> = ({ onSubmit, onClose }) => {
  const [blockNumber, setBlockNumber] = useState("Left Wing, Hostel B");
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log({ blockNumber, roomNumber, phoneNumber, description });
      ...
      >
        ...
        <FormControl fullWidth margin="normal" variant="outlined">
          ...
          <Select
            ...
            label="Block Number"
          >
            <MenuItem value="Left Wing, Hostel B">Left Wing, Hostel B</MenuItem>
            <MenuItem value="Right Wing, Hostel B">Right Wing, Hostel B</MenuItem>
            <MenuItem value="Left Wing, Hostel A">Left Wing, Hostel A</MenuItem>
            <MenuItem value="Right Wing, Hostel A">Right Wing, Hostel A</MenuItem>
            <MenuItem value="Left Wing, Hostel C">Left Wing, Hostel C</MenuItem>
            <MenuItem value="Right Wing, Hostel C">Right Wing, Hostel C</MenuItem>
            <MenuItem value="Left Wing, Hostel RK">Left Wing, Hostel RK</MenuItem>
            <MenuItem value="Right Wing, Hostel RK">Right Wing, Hostel RK</MenuItem>
          </Select>
        </FormControl>
        ...
        <Box display="flex" justifyContent="space-between" mt={3}>
          <Button type="submit" variant="contained" sx={{ bgcolor: "#FFA500", color: "white" }}>
            Submit
          </Button>
