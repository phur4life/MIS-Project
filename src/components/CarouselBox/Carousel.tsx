			...
			>
				...
				<DialogContent>
					<RequestForm
						...
						onClose={handleCloseDialog}
						selectedService={{ title, description, id }}
					/>
				</DialogContent>
			</Dialog>
		</>
...
const Carousel = () => {
	...
	return (
		<Box
			className="carousel-container h-[700px]"
			sx={{ bgcolor: "#212533", px: 4 }}
		>
			<Box display="flex" justifyContent="space-between" alignItems="center">
				<Typography
					variant="h6"
					color="white"
					className={`${spectral.className} text-[60px] w-full text-center`}
				>
					Services for you
				</Typography>
