      ...
      >
        <span className="h-12 w-12 rounded-full">
          <Image
            width={112}
            height={112}
            src="/images/logo/logo.png" // Corrected src path
            alt="User"
        ...
        <span className="flex items-center gap-2 font-medium text-dark dark:text-dark-6">
          <span className="hidden lg:block">{user ? user.name : 'User'}</span> {/* Updated to use dynamic user name */}
          <svg
        ...
        <div className="absolute right-0 mt-7.5 flex w-[280px] flex-col rounded-lg border-[0.5px] border-stroke bg-white shadow-default dark:border-dark-3 dark:bg-gray-dark">
          <div className="flex items-center gap-2.5 px-5 pb-5.5 pt-3.5">
            ...
            <span className="block">
              <span className="block font-medium text-dark dark:text-dark">{user ? user.name : 'User'}</span> {/* Updated to use dynamic user name */}
              <span className="block font-sm text-dark-5 dark:text-white-6">{user ? user.email : 'email@example.com'}</span> {/* Updated to use dynamic user email */}
            </span>
          </div>
